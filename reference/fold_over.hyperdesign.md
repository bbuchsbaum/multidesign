...
When exactly the declared entity ID is supplied, each fold holds that
entity out from every block in which it occurs. This is a generic data
split; it is not the landmark-based-weighting or smoothness
cross-validation procedure used by specialized generalized Procrustes
solvers.
