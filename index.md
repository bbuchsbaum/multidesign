...
[Getting
started](https://bbuchsbaum.github.io/multidesign/vignettes/Introduction.Rmd)
· [Class
overview](https://bbuchsbaum.github.io/multidesign/vignettes/class_overview.Rmd)
· [Changelog](https://bbuchsbaum.github.io/multidesign/NEWS.md) · [Issue
...
always row-stacks; it never joins by `id`, and it refuses
`space = "block"`.
[`align_by_id()`](https://bbuchsbaum.github.io/multidesign/reference/align_by_id.md)
is the explicit join: it returns common-space arrays on the global
entity universe, but it does not fit an alignment model.
...
- [Changelog](https://bbuchsbaum.github.io/multidesign/NEWS.md)
